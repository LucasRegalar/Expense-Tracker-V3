<x-secondary-card class="mt-3 text-sm">
    <div class="flex justify-between items-center">
        <div class="flex items-center gap-3">
                <svg class="h-10 min-w-10 fill-primary-text" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="ml-4 flex flex-col gap-3 group">
                <div class="flex items-center">
                    <div class="h-3 w-3 mr-4 bg-main-red rounded-full"></div>
                    <div>Hoodie</div>
                </div>

                <div class="flex gap-5 group-hover:hidden">
                    <div>80,00€</div>
                    <div class="flex items-center gap-1">
                        <svg class="h-4 w-4 fill-primary-text" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="hidden group-hover:block">
                    <ul class="text-sm flex gap-2">
                        <h3>Categories:</h3>
                        <li class="text-main-green">Groceries,</li>
                        <li>WG</li>
                    </ul>
                </div>
            </div>
        ...
        <form action="">
            <button class="cursor-pointer">
                <svg class="h-5 w-5 fill-primary-text" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path
